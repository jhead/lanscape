use crate::protocol::{AgentMessage, BrowserMessage, MessageType};
...
impl Bridge {
            ...
            webrtc_clone
                .set_on_data_channel(Box::new(move |peer_id: String, dc: Arc<webrtc::data_channel::RTCDataChannel>| {
                    ...
                    Box::pin(async move {
                        ...
                        dc.on_message(Box::new(move |msg: crate::webrtc::DataChannelMessage| {
                        ...
                        if dc.ready_state() == crate::webrtc::RTCDataChannelState::Open {
    ...
    pub async fn get_connected_peers(&self) -> Vec<String> {
        ...
        data_channels
            .iter()
            .filter(|(_, dc)| dc.ready_state() == crate::webrtc::RTCDataChannelState::Open)
